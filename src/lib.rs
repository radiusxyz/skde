...
// #[derive(Clone, Debug)]
// pub struct AggregateCircuit<F: PrimeField, const T: usize, const RATE: usize> {
...
// impl<F: PrimeField + FromUniformBytes<64>, const T: usize, const RATE: usize> AggregateCircuit<F, T, RATE> {
//     pub const BITS_LEN: usize = 2048; // n's bit length
//     pub const LIMB_WIDTH: usize = AggregateChip::<F, T, RATE>::LIMB_WIDTH;
...
// impl<F: PrimeField, const T: usize, const RATE: usize> Circuit<F> for AggregateCircuit<F, T, RATE> {
...
//                     AggregatePublicParams::new(n_unassigned.clone());
//                 let public_params =
...
// #[test]
// fn test_aggregate_circuit_with_hash() {
//     use halo2wrong::curves::bn256::Fr;
//     use halo2wrong::halo2::dev::MockProver;
//     use num_bigint::RandomBits;
//     use rand::{thread_rng, Rng};
//     let mut rng = thread_rng();
//     let bits_len = AggregateCircuit::<Fr, 5>::BITS_LEN as u64;
//     let mut n = BigUint::default();
//     let limb_width = AggregateCircuit::<Fr, 5>::LIMB_WIDTH as usize;
...
//     for _ in 0..AggregateCircuit::<Fr, 5>::MAX_SEQUENCER_NUMBER {
//         let u = rng.sample::<BigUint, _>(RandomBits::new(bits_len)) % &n;
//         // let v = rng.sample::<BigUint, _>(RandomBits::new(bits_len * 2)) % &n_square;
//         // let y = rng.sample::<BigUint, _>(RandomBits::new(bits_len)) % &n;
//         // let w = rng.sample::<BigUint, _>(RandomBits::new(bits_len * 2)) % &n_square;
...
//     let circuit = AggregateCircuit::<Fr, 5> {
//         partial_keys,
//         aggregated_key,
//         n,
//         hashes,
